...
function rehub_before_import_setup( $current_import ){
	...
	if( 'RePick' === $current_import['import_file_name'] || 'ReMag' === $current_import['import_file_name'] || 'ReCash' === $current_import['import_file_name'] || 'ReDeal' === $current_import['import_file_name'] || 'ReViewit' === $current_import['import_file_name'] ) {
